...
import { FileCheck2, Monitor, ShieldCheck, Smartphone, Tablet } from "lucide-react";
  ...
  return (
    <section className="whs-domain">
      <div className="whs-domain-toolbar">
        ...
        <div className="whs-device-selector" role="group" aria-label="WHS and EC Forms device preview">
          <span className="whs-device-selector__label">Preview</span>
          <div className="whs-device-selector__options" role="radiogroup" aria-label="Choose device size">
      ...
      <div className="whs-device-preview-shell">
        <div className={`whs-device-frame whs-device-frame--${device}`} data-device={device}>
          <div id={contentId} role="tabpanel" className="whs-device-frame__screen">
            {subdomain === "forms"
              ? <StaffForms />
