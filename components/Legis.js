...
export default function Legis({ compact = false }) {
  ...
  return (
    <div className={`lg${compact ? " lg-compact" : ""}`}>
      <style>{`
        .lg { border: 1px solid #CBD5E1; border-radius: 12px; padding: 20px 16px; margin-bottom: 12px; background: #F8FAFC; }
        .lg-development { background: #FFFFFF; }
        ...
        .lg-development-dates { display: flex; gap: 12px; flex-wrap: wrap; font-size: 11px; color: #64748B; margin-bottom: 8px; }
        ...
        .lg-triggers { font-family: 'IBM Plex Mono', monospace; font-size: 10px; color: #64748B; margin-bottom: 6px; }
