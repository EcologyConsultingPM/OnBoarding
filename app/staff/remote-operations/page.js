...
import RemoteOperationsWorkspace from "../../../components/RemoteOperationsWorkspace";

export default function StaffRemoteOperationsPage() {
  ...
  return <RemoteOperationsWorkspace />;
}
