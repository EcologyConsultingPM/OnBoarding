  ...
  const signInWithEmail = useCallback(async (email) => {
    ...
    try {
      ...
      if (error) {
        ...
        return { error: error.message || "Couldn't send the sign-in link. Try again in a moment." };
      }
      return { error: null };
    } catch (err) {
  ...
  const sendPasswordReset = useCallback(async (email) => {
    ...
    try {
      ...
      if (error) {
        ...
        return { error: error.message || "Couldn't send the reset link. Try again in a moment." };
      }
      return { error: null };
    } catch (err) {
