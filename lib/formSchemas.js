...
export const FORM_SCHEMAS = {
  ...
  "psychosocial_self_risk_assessment": {
    "label": "Psychosocial Self Risk Assessment",
    "group": "WHS & office",
    "kind": "whs",
    "sections": []
  },
  ...
  "site_erp": {
    "label": "Site-specific emergency response plan (ERP)",
    "group": "Field & mobilisation",
    "kind": "whs",
    "sections": [
      {
    ...
    "sections": [
      ...
      },
      {
        ...
        "fields": [
          [
            "sopReference",
            "Standard Operating Procedures (SOPs) applied",
            "textarea"
          ],
          [
            "steps",
  ...
  "ecological_field_swms": {
    "label": "Generic SWMS — Ecological Field Surveys",
    "group": "Field & mobilisation",
    "kind": "whs",
    "sections": []
  }
